...
function add_css_head() {
	...
	if ( ! is_user_logged_in() ) :
		...
		<style>
			...
			.entry-content .wp-block-gallery img[alt=""], .entry-content .wp-block-gallery img:not([alt]),
			.entry-content .wp-block-image img[alt=""], .entry-content .wp-block-image img:not([alt]),
			.entry-content p img[alt=""], .entry-content p img:not([alt]),
			.introduction p img[alt=""], .introduction p img:not([alt]),
			.tribe-events-event-image img[alt=""] {
				display: none;
			}
		</style>
	<?php endif;
